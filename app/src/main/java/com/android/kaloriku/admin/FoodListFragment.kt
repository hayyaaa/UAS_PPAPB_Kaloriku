...
class FoodListFragment : Fragment() {
    ...
    private lateinit var foodAdapter: FoodListAdapter // digunakan untuk mengatur daftar makanan dalam RecyclerView.

    private val firestore = FirebaseFirestore.getInstance() // untuk berinteraksi dengan database Firestore
    ...
    // digunakan untuk mengamati perubahan pada daftar data makanan
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            // mengamati perubahan dataMakananLiveData
    ...
    private fun getAllData() {
        // Mengambil semua data makanan dari Firestore, kemudian diolah dan ditampilkan di RecyclerView melalui adapter foodAdapter
    ...
    private fun delete(dataMakanan: DataMakanan){
        // menghapus data makanan di firestore berdasarkan id
